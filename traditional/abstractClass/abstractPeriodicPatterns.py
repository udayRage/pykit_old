...
class periodicFrequentPatterns(ABC):
    """ This abstract base class defines the variables and methods that every periodic pattern mining algorithm must
    employ in PAMI
        ...
        maxPer: float
            UserSpecified maximum periodicity value. It has to be given in terms of count of total number of
        ...
        oFile : str
            Name of the output file to store complete set of periodicFrequent patterns
        memoryUSS : float
        ...
        storePatternsInFile(oFile)
            Complete set of periodicFrequent patterns will be loaded in to a output file
        getPatternsInDataFrame()
            Complete set of periodicFrequent patterns will be loaded in to data frame
        getMemoryUSS()
    ...
    @abstractmethod
    def oFile(self):
        """Variable to store the name of the output file to store the complete set of periodicFrequent patterns"""
    ...
    def storePatternsInFile(self, oFile):
        """Complete set of periodicFrequent patterns will be saved in to an output file from this function
    ...
    def getPatternsInDataFrame(self):
        """Complete set of periodicFrequent patterns will be loaded in to data frame from this function"""
